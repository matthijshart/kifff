...
var I18N = {
  en: {
    ...
    // Pricing
    nav_pricing: 'Pricing',
    pricing_eyebrow: 'Pricing', pricing_title: 'Transparent pricing, no surprises',
    pricing_desc: 'Start free and scale up when you\'re ready. No commitments, no hidden costs.',
    pricing_free_name: 'Free', pricing_free_desc: 'Discover the power of data-driven risk assessment',
    pricing_pro_name: 'Professional', pricing_pro_desc: 'For legal teams and claims departments that analyze daily',
    pricing_ent_name: 'Enterprise', pricing_ent_desc: 'For insurers and large law firms',
    pricing_period_month: '/month',
    pricing_pro_annual: 'or \u20ac69/month with annual plan',
    pricing_ent_price: 'Custom',
    pricing_free_f1: '5 risk analyses per month', pricing_free_f2: 'Access to data insights',
    pricing_free_f3: 'Basic comparable rulings', pricing_free_f4: 'No PDF analysis',
    pricing_free_f5: 'No insurer analytics',
    pricing_pro_f1: 'Unlimited risk analyses', pricing_pro_f2: 'PDF policy terms scanning',
    pricing_pro_f3: 'Insurer analytics & benchmarks', pricing_pro_f4: 'Extended comparable rulings',
    pricing_pro_f5: 'Exportable reports',
    pricing_ent_f1: 'Everything in Professional', pricing_ent_f2: 'API access for integration',
    pricing_ent_f3: 'Multiple user accounts', pricing_ent_f4: 'Dedicated support & onboarding',
    pricing_ent_f5: 'Custom models on your data',
    pricing_free_cta: 'Start free', pricing_pro_cta: 'Start 14-day free trial', pricing_ent_cta: 'Contact us',
    pricing_popular: 'Most popular',
    pricing_trust1: '14-day free trial', pricing_trust2: 'Cancel anytime', pricing_trust3: 'No credit card needed for free plan',
    // Insurer tab
  ...
  nl: {
    ...
    // Pricing
    nav_pricing: 'Kosten',
    pricing_eyebrow: 'Kosten', pricing_title: 'Transparante prijzen, geen verrassingen',
    pricing_desc: 'Start gratis en schaal op wanneer u klaar bent. Geen verplichtingen, geen verborgen kosten.',
    pricing_free_name: 'Gratis', pricing_free_desc: 'Ontdek de kracht van datagedreven risico-inschatting',
    pricing_pro_name: 'Professional', pricing_pro_desc: 'Voor juristen en schadeteams die dagelijks analyseren',
    pricing_ent_name: 'Enterprise', pricing_ent_desc: 'Voor verzekeraars en grote advocatenkantoren',
    pricing_period_month: '/maand',
    pricing_pro_annual: 'of \u20ac69/maand bij jaarabonnement',
    pricing_ent_price: 'Op maat',
    pricing_free_f1: '5 risico-analyses per maand', pricing_free_f2: 'Toegang tot data-inzichten',
    pricing_free_f3: 'Basis vergelijkbare uitspraken', pricing_free_f4: 'Geen PDF-analyse',
    pricing_free_f5: 'Geen verzekeraar-analytics',
    pricing_pro_f1: 'Onbeperkte risico-analyses', pricing_pro_f2: 'PDF polisvoorwaarden scannen',
    pricing_pro_f3: 'Verzekeraar-analytics & benchmarks', pricing_pro_f4: 'Uitgebreide vergelijkbare uitspraken',
    pricing_pro_f5: 'Exporteerbare rapporten',
    pricing_ent_f1: 'Alles in Professional', pricing_ent_f2: 'API-toegang voor integratie',
    pricing_ent_f3: 'Meerdere gebruikersaccounts', pricing_ent_f4: 'Dedicated support & onboarding',
    pricing_ent_f5: 'Custom modellen op uw data',
    pricing_free_cta: 'Gratis starten', pricing_pro_cta: 'Start 14 dagen gratis', pricing_ent_cta: 'Neem contact op',
    pricing_popular: 'Meest gekozen',
    pricing_trust1: '14 dagen gratis proberen', pricing_trust2: 'Maandelijks opzegbaar', pricing_trust3: 'Geen creditcard nodig voor gratis plan',
    // Insurer tab
